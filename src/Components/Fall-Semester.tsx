...
export function FallTable({disabled, showEditModal}: {disabled: boolean, showEditModal: (b:boolean)=>void} ): JSX.Element {
    ...
    return <div>
        <table className="Table-Header" style={disabled ? { pointerEvents: "none", opacity: "0" } : {}}>
